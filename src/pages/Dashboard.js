      ...
      case 'dashboard':
        return (
          <div>
            ...
            <p>Aquí puedes gestionar la información y datos de departamentos de la empresa y de empleados.</p>
          </div>
        );
      default:
      ...
      <div className="sidebar">
        ...
        <nav>
          <ul>
            ...
            <li onClick={() => setActiveComponent('employees')}>
            ...
            <li onClick={() => setActiveComponent('departments')}>
